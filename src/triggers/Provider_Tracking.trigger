...
======================================================
======================================================
Purpose: Trigger for Provider_Tracking
======================================================
======================================================
History                                                            
-------                                                            
...
***********************************************************************/
trigger Provider_Tracking on Provider_Tracking__c ( before insert, 
													before update, 
													before delete, 
													after insert, 
													after update, 
    ...
    if (Test.isRunningTest() || setting.Provider_Tracking__c) {
